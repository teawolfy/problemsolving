...
def my_factor(x):
    """the my_factor takes an integer and returns a list containing the factors of the integer
    1. the function only needs to check the numbers up through the square root of the integer, because any factor
        larger than the square root will have the corresponding factor that is less than the square root (i.e. 25 and 5 for 100)
